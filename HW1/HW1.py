...
# LR MSE = 0.157
# Baseline MSE = 0.440
# LR was able to fit the training set and was able to achieve lower MSE compared to
# baseline MSE.
...
# Baseline MSE = 0.440
# Lambda = 67.387
# As a biased esimator, Ridge Regression was able to even lower MSE by penalizing
# with lambda.
...
# Lasso selected lcavol, lweight, and svi features to include in the model. The features make sense
# since the correlation with those feature and lpsa (output) are high compared to other features.
# lcvol has the largest correlation to the output with the value 0.734460, and it is the one that Lasso weighted most.
