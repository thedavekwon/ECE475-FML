...
# Q1                                                                             #
##################################################################################
def linear_regression(X_train, y_train, column_names, z_score=True):
    LR = LinearRegression()
...
linear_regression(X_train, y_train, column_names, False)
# ridge_regression(X_train, y_train, test, val, column_names)
# lasso_regression(X_train, y_train, test, val, column_names)
...
nonlin_wine_data = np.hstack(
    (
        ...
        np.log(wine_data[:, 0]).reshape(len(wine_data), 1),
        wine_data,
    )
)
print(wine_data.shape, nonlin_wine_data.shape)
...
linear_regression(X_train, y_train, new_columns, False)
# ridge_regression(X_train, y_train, test, val, column_names)
# lasso_regression(X_train, y_train, test, val, column_names)
# print(column_names)
# col = 3
