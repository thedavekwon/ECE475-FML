...
# Q2                                                                             #
##################################################################################
def ridge_regression(X_train, y_train, test, val):
    mses = []
    beta_ridges = []
    for l in ls:
...
# ridge_regression(X_train, y_train, test, val)

##################################################################################
# Q3                                                                             #
##################################################################################
def lasso_regression(X_train, y_train, test, val):
    mses = []
    beta_lasso = []
...
# lasso_regression(X_train, y_train, test, val)
