...
# ridge_regression(X_train, y_train, X_test, y_test, X_val, y_val, val, column_names)
# lasso_regression(X_train, y_train, X_test, y_test, X_val, y_val, val, column_names)
...
linear_regression(X_train, y_train,X_test, y_test, new_columns, False)
