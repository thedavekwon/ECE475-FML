...
# Preprocesing the prostate data
...
corr = prostate_df.corr()  # Find correlation between features
...
# lasso_regression(X_train_without_b, y_train, X_test, y_test, X_val, y_val, column_names)
