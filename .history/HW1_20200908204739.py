...
train, temp = train_test_split(prostate_data, test_size=0.2, random_state=51)
test, val = train_test_split(temp, test_size=0.5, random_state=51)
...
# find_beta_ridge = (
#     lambda l: inv(X.T @ X + l * np.identity(X.shape[1])) @ X.T @ y
# )
# mses = []
# beta_ridges = []
