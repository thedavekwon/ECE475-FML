...
##### Nonlinear
# no it turns all the features to new princple componenet features
nonlin_wine_data = np.hstack(((wine_data[:,0]*wine_data[:,6]).reshape(len(wine_data),1), (wine_data[:,0]*wine_data[:,7]).reshape(len(wine_data),1), wine_data))
